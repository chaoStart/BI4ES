...
index_name = "ragflow_sciyonff8bcdc11efbdcf88aedd6333bi_jkdata"
...
def hybrid_search_indicator(query_text, query_vector, id="691222347303550994"):
    # ====== 1. 关键词检索 ======
    keyword_query = {
        "bool": {
            "must": [
...
# 用户输入问题
query_text = "CWYB2407利润明细表（续）"

query_vector = get_embedding(query_text)

# 检索ES数据
results = hybrid_search_indicator(query_text, query_vector, id="691222347303550994")
